 ...
 */
class getSectorRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SectorRepository' shared autowired service.
     *
     * @return \App\Repository\SectorRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SectorRepository.php';

        return $container->privates['App\\Repository\\SectorRepository'] = new \App\Repository\SectorRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
